...
```
git clone https://gitlab.vhar.ru/pub/go-stribog.git
```
...
Техническую поддержку осуществляет автор по электронной почте.  

Автор не оказывает услуг по установке и сопровождению сервиса.  
Автор не оказывает консультационных услуг, связанных с использованием программного обеспечения стороннего производителя.  
Автор не оказывает консультационных услуг, связанных с общей компьютерной грамотностью.  

В рамках технической поддержки включены следующие услуги:  
- выявление ошибок в функционировании Программного обеспечения;
- исправление ошибок, выявленных в функционировании продукта;
- прием заявок от конечного пользователя на внесение изменений и дополнений в сервис;
- модернизация

Свои вопросы вы можете отправить на адрес:
- v@vhar.ru  
- vhar@mail.ru

В письме укажите ваш вопрос, приложите поясняющие скриншоты.  
>заголовк письма должен содержать слово GoGOST

Выявленные ошибки будут устранятся по мере выхода обновлений.  

Пользователи могут направлять предложения по усовершенствованию продукта электронный адрес автора vhar@mail.ru.  
Каждое предложение будет рассмотрено и, в случае признания его целесообразности, в сервис будут внесены соответствующие изменения.  
